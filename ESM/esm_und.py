...
varParam = srwl_bl.srwl_uti_ext_options([
    ['name', 's', 'NSLS-II ESM DIAGON', 'simulation name'],
...
#---Undulator
    ...
    ['und_by', 'f', 0.37578053, 'undulator vertical peak magnetic field [T]'],
    ...
    ['und_g', 'f', 33.5, 'undulator gap [mm] (assumes availability of magnetic measurement or simulation data)'],
...
#---Calculation Types
    ...
    ['tr_np', 'f', 2000, 'number of points for trajectory calculation'],
    ...
    ['sm_hf', 'i', 5, 'final UR spectral harmonic to be taken into account for multi-e spectrum vs photon energy calculation'],
    ...
    ['w_e', 'f', 700.0, 'photon energy [eV] for calculation of intensity distribution vs horizontal and vertical position'],
    ...
    ['w_rx', 'f', 0.02, 'range of horizontal position [m] for calculation of intensity distribution'],
    ['w_nx', 'i', 100, 'number of points vs horizontal position for calculation of intensity distribution'],
    ['w_y', 'f', 0.0, 'central vertical position [m] for calculation of intensity distribution vs horizontal and vertical position'],
    ['w_ry', 'f', 0.02, 'range of vertical position [m] for calculation of intensity distribution vs horizontal and vertical position'],
